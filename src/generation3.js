...
const BUILD = "command-g3-2026-09-06";
...
function injectStyles() {
  ...
  style.textContent = `
    ...
    @media(max-width:720px){.g3-grid,.g3-grid.two,.g3-kpi{grid-template-columns:1fr}.g3-queue-item{grid-template-columns:1fr}.g3-actions{justify-content:flex-start}.g3-page-header{align-items:flex-start}}
  `;
